  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-2xl cursor-pointer transition-all duration-200 group relative ${active
      ...
      <div className="relative">
        <div className={`w-12 h-12 rounded-full overflow-hidden border-2 transition-colors ${active
            ? 'border-blue-500'
            : isUnread
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-baseline mb-0.5">
          <h3 className={`truncate text-[15px] ${active
          ...
          {timestamp && !isNaN(new Date(timestamp).getTime()) && (
            <span className={`text-[10px] tabular-nums ${isUnread
                ? 'font-bold text-blue-600 dark:text-blue-400'
        ...
        <div className="flex items-center justify-between gap-2">
          <p className={`text-xs truncate ${active
